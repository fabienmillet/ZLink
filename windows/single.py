...
"""Coordinateur mode 1 écran — pilule nav auto-hide style RDP/VMware."""
...
_NAV_W: int = 310      # largeur de la pilule
...
# ---------------------------------------------------------------------------
# _NavPill — pilule flottante auto-hide
# ---------------------------------------------------------------------------

class _NavPill(QWidget):
    """Pilule centrée en haut, masquée hors-écran, révélée au survol du bord."""
    ...
    def __init__(
        ...
        self.move(self._center_x, self._hidden_y)
...
class SingleModeShell:
    ...
    def _check_cursor(self) -> None:
        # Ne pas interférer si une autre application est au premier plan
